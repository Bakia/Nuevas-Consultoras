				...
				switch(cualArrayNom){
					...
					case listaAmigosArrayNom:
						...
						if(listaAmigosArrayNom.length <= 3){
							  ...
							  /*$("#postits-amigas").find(".postit").each(function(index, element) {
                                   	$(element).find(".nombre-amiga").text(listaAmigosArrayNom[indexAm_1]);
									indexAm_1 ++;
									////////////console.log($(element).find(".nombre-amiga").val());
							  });*/
							  
							  /*$("#postits-amigas").find(".postit").each(function(index, element) {
                                   	var cualAmigo = "amigo" + index;
									$(element).find(".nombre-amiga").text(listaAmigosArrayNom[indexAm_1]);
									indexAm_1 ++;
									
							  });
							  
							  $("#postits-amigas_2").find(".postit").each(function(index, element) {
                                   	$(element).find(".nombre-amiga").text(listaAmigosArrayNom[indexAm_2]);
									indexAm_2 ++;
									////////////console.log($(element).find(".nombre-amiga").val());
							  });
							  
							  $("#postits-amigas_3").find(".postit").each(function(index, element) {
                                   	$(element).find(".nombre-amiga").text(listaAmigosArrayNom[indexAm_3]);
									indexAm_3 ++;
									////////////console.log($(element).find(".nombre-amiga").val());
							  });*/
							 ...
							 /* $("#postits-amigas .postit").remove();
							  $("#postits-amigas_2 .postit").remove();
							  $("#postits-amigas_3 .postit").remove();
							 
							  var totArrayAm = listaAmigosArrayNom.length;
							  ...
							  for(var i = 0; i < totArrayAm ; i++){
								  
							     $("#postits-amigas").append("<div class='postit' id='amiga_1_"+i+"' style='left: "+left_post_1+"px; top: 460px;'><img src='img/02/act_secciones/papel.png'><span class='relacion'></span><span style='left: 30px; top: 33px; position: absolute; ' class='nombre-amiga'>"+listaAmigosArrayNom[i]+"</span></div>");
								 
								 left_post_1 = left_post_1 + 125;
								 
								 
								 $("#postits-amigas_2").append("<div class='postit' id='amiga_2_"+i+"' style='left: "+left_post_2+"px; top: 460px;'><img src='img/02/act_secciones/papel.png'><span class='relacion'></span><span style='left: 30px; top: 33px; position: absolute; ' class='nombre-amiga'>"+listaAmigosArrayNom[i]+"</span></div>");
								 
								 left_post_2 = left_post_2 + 125;
								 
								 
								 $("#postits-amigas_3").append("<div class='postit' id='amiga_3_"+i+"' style='left: "+left_post_3+"px; top: 460px;'><img src='img/02/act_secciones/papel.png'><span class='relacion'></span><span style='left: 30px; top: 33px; position: absolute; ' class='nombre-amiga'>"+listaAmigosArrayNom[i]+"</span></div>");
...
jQuery.fn.extend({
	...
	$("#"+idDiv).find(".btn_enviar_correo").click(function(e){
		...
		var arroba = /.\@./;
		var punto  = /.\../;
		var contenido_email = "Lista de Cobranzas:";
		...
		if(arroba.test(correo_persona) == false){
			...
			if(punto.test(correo_persona) == false){
				...
				for(var c = 0; c < arraySpanAgenda.length ; c++){
					switch(c){
						case 0:
							contenido_email = contenido_email+ " Nombre: " +arraySpanAgenda[c];
						break;
						
						case 1:
							contenido_email = contenido_email+ " Campaña: " +arraySpanAgenda[c];
						break;
						
						case 2:
							contenido_email = contenido_email+ " Productos pedido: " +arraySpanAgenda[c];
						...
						case 6:
						case 7:
							contenido_email = contenido_email+ " * " +arraySpanAgenda[c];
						break;
						
						case 8:
							contenido_email = contenido_email+ " Monto de Pedido: " +arraySpanAgenda[c];
						break;
						
						case 9:
							contenido_email = contenido_email+ " Adelanto: " +arraySpanAgenda[c];
						break;
						
						case 10:
							contenido_email = contenido_email+ " Saldo: " +arraySpanAgenda[c];
						break;
						
						case 11:
							contenido_email = contenido_email+ " Fecha de cobranza: " +arraySpanAgenda[c];
						break;
